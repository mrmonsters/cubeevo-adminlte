        ...
        <div class="row content-wrapper-layer content-wrapper-first-layer">
            <div class="content-wrapper"
                ...
                <div class="col-xs-12 content-wrapper__content-contact-us text-white">
                    ...
                    @else
                    <p class="content-wrapper__content-contact-us-subheading hidden-xs">NEW BUSINESS & COLLABORATIONS</p>
                    @endif
                            ...
                            <p style="line-height: 1em;" class="content-wrapper__content-contact-us-address ">
                                <small style="position: relative">
                                    ...
                                    @if (Session::get('locale') == 'cn')
                                        ...
                                        (UEN - 201604241R)
                                    @else
                                        CUBEevo ADVERTISING PTE LTD <span class="homepage-line homepage-line-custom hidden-xs"></span><br/>
                                        (UEN - 201604241R)
                                    @endif
                                    <br/>
                                    20 Maxwell Rd<br/>
