<div class="col-sm-5 col-lg-4 col-sm-offset-4 col-lg-offset-5">
    <h1>
        <?php echo (Session::get('locale') == 'en') ? 'Transforming Intern<br/> Into Young Talents' : 'Transforming Intern<br/> Into Young Talents';?>
    </h1>
    <div class="line__internship line__internship-1"></div>
</div>
<div class="col-sm-4 col-sm-offset-5 col-lg-offset-6 m-t-xxl">
    <div class="author-name hidden-xs"><img src="{{asset('img/Career_02-04.svg')}}"/></div>
    <p>CUBEevo Director, a young and talented artist of the company. He started the company with his partner
        in year 2007 without a single account in hand. But today, CUBEevo has transformed itself as a
        professional young advertising agency having numerous satisfied clients. Undoubtedly, the
        transformation was not easy, it was done in sweat and blood.</p>
    <p>He didn’t get the chance to be an intern, but he volunteered himself to work underpaid just to get
        real experience in advertising which was priceless to him. Therefore, the young talents who have
        infinite new ideas and creativity should be given a platform to showcase their capabilities.</p>
    <p>Thinking outside the box is not enough, tearing up the box is what he is looking out on the new born
        artists. Should you be one of them?</p>
</div>
<div class="col-sm-4 m-t-lg m-b-lg">
    <span class="line__internship line__internship-2 pull-right"></span>
    <p class="text-right clear">
        “To practice any art, no matter how well or badly,<br/>
...
<div class="col-sm-5 col-lg-4 col-sm-offset-4 col-lg-offset-5 m-b-n-lg internship-content-1">
    ...
    <p class="m-b-lg">
        ...
        Since we are in a designing industry, the skills in art and design are equally important. The
    ...
    <p class="m-b-lg">
        ...
        are able to bring out the real potential in them which is beneficial for their future development.
