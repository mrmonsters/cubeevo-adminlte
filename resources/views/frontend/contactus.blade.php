        ...
        <div class="row" style="position:relative;">
            <div class="col-sm-10 col-sm-offset-2">
                <div>
                    ...
                    <h5><?php echo (Session::get('locale') == 'en') ? "If there's anything that you need from our service, feel free to leave us your contact and information. <br/><br/>We can't wait to get in touch with you." : '任何服务方案需求，欢迎留下您的联系方式，我们迫不及待想与您愉快聊天！';?></h5>
                </div>
            </div>
        </div>
        <br/>
