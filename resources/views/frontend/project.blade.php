...
<div class="container-fluid cre">
    @if (isset($projects) && is_array($projects) && !empty($projects))
        ...
        @foreach ($projects as $project)
            ...
            @endif
            <div class="col-sm-6" onClick="location.href='{{ url('credential/project/' . $project['id']) }}';" style="background: <?php echo ($project['bg_img_id'] != '') ? "url('.." . Files::find($project['bg_img_id'])->dir . "') no-repeat; background-size: cover;" : "#666; min-height: 281px;" ?>">
                <div class="contbox">
