...
@section('frontend-content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-4 panelHeight-5 background-1">
            ...
            <div class="col-sm-4 panelHeight-5 background-2">
                <div class="panelBody vcenter">
                    <div class="greybox"
            ...
            <div class="col-sm-4 panelHeight-5 background-3">
                <div class="panelBody vcenter">
                    <div class="greybox"
            ...
            <div class="col-sm-4 panelHeight-5 background-4">
                <div class="panelBody vcenter">
                    <div class="greybox"
            ...
            <div class="col-sm-4 panelHeight-5 background-5">
                <div class="panelBody vcenter">
                    <div class="greybox"
            ...
            <div class="col-sm-4 panelHeight-5 background-6">
                <div class="panelBody vcenter">
                    <div class="greybox"
