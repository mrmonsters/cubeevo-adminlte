...
<div class="container-fluid sol">
  ...
  background-size: cover;background-size: 110% auto;">
                <div class="contbox">
                    ...
                    <div class="row panel-body overlap vcenter">
                        <div>
                            <h1 class="col-xs-12 hidden-text text-center panel-title text-white">{{ $solution->translate(Session::get('locale'))->name }}</h1>
