...
<div class="container-fluid cre">
    @if (isset($categories) && is_array($categories) && !empty($categories))
        ...
        @foreach ($categories as $category)
            ...
            @endif
            <div class="col-sm-4" onClick="location.href='{{ url('credential/' . $category['id']) }}';" style="background: <?php echo ($category['grid_bg_img_id'] != '') ? "url('.." . Files::find($category['grid_bg_img_id'])->dir . "');" : "#666; min-height: 281px;" ?>">
                <div class="contbox">
