							...
							<div class="thumbnail">
								...
								<div class="caption" style="text-align: center;">
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<a href="#" class="btn btn-block btn-default" role="button" data-toggle="modal" data-target="#modal-upload" onclick="useExist('grid_img_id')"><i class="fa fa-cloud-upload"></i> Use Existing</a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="thumbnail">
								...
								<div class="caption" style="text-align: center;">
									...
									<div class="row">
										...
										<div class="col-xs-6">
											<a href="#" class="btn btn-block btn-default" role="button" data-toggle="modal" data-target="#modal-upload" onclick="useExist('grid_bg_img_id')"><i class="fa fa-cloud-upload"></i> Use Existing</a>
										</div>
									</div>
								</div>
							</div>
