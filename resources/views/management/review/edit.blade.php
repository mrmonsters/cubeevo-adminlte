...
@section('main-content')
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary" ng-controller="ReviewUpdateCtrl" ng-init="reviewer = {{ json_encode($reviewerData) }}; init();">
                                        ...
                                        <div id="{{ $locale->language }}" class="tab-pane {{ ($index != 0) ? : 'active' }}">
                                            ...
                                            @if ($locale->language == 'en')
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                    <tr ng-repeat="review in reviewer.reviews.en | orderBy: 'sort'" ng-if="review.deleted != 1">
                                                        <td>@{{ review.question }}</td>
                                                        <td>@{{ review.answer }}</td>
                                                        <td>@{{ review.sort }}</td>
                                                        <td>
                                                            <button type="button" class="btn btn-default" ng-click="editReview(review)">Edit</button>
                                                            <button type="button" class="btn btn-danger" ng-click="delReview(review, 'en')">Delete</button>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            ...
                                            @elseif ($locale->language == 'cn')
                                                <table class="table table-bordered">
                                                    ...
                                                    <tbody>
                                                    <tr ng-repeat="review in reviewer.reviews.cn | orderBy: 'sort'" ng-if="review.deleted != 1">
                                                        <td>@{{ review.question }}</td>
                                                        <td>@{{ review.answer }}</td>
                                                        <td>@{{ review.sort }}</td>
                                                        <td>
                                                            <button type="button" class="btn btn-default" ng-click="editReview(review)">Edit</button>
                                                            <button type="button" class="btn btn-danger" ng-click="delReview(review, 'cn')">Delete</button>
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
