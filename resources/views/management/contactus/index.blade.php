					...
					<tbody>
						...
						<tr>
							...
							<td>
								...
								<a  onclick="javascript: if (confirm('Are you sure you want to delete this?')) { href='{{ url('admin/manage/message/destroy/' . $message->id) }}'} else { alert('Delete Cancelled.') }; "   href="#"  class="btn btn-danger">Delete</a>
							</td>
						</tr>
						@endforeach
						@endif
