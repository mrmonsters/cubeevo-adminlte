...
<div class="row">
	<div class="col-md-12">
		<div class="box box-primary">
			...
			<form method="POST" action="{{ url('manage/solution/update/' . $solution->id) }}" accept-charset="UTF-8" enctype="multipart/form-data">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<input id="link" name ="link" type="text" class="form-control" value="{{ $solution->link }}" />
					</div>
					<div class="form-group">
					...
					<div class="row">
						...
						<input type="hidden" id="grid_img_id" name="grid_img_id" value="{{ $solution->grid_img_id }}" />
						<div class="col-md-4">
							<div class="thumbnail">
						...
						<input type="hidden" id="grid_bg_img_id" name="grid_bg_img_id" value="{{ $solution->grid_bg_img_id }}" />
					</div>
				</div>
