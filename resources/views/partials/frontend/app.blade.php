                ...
                <div class="content-section">
                    <div class="row">
                        <div class="col-sm-push-4 col-md-push-5  col-sm-7">
                            ...
                            <p>形立方追求灵活，弹性，务必让合作过程更加灵活，<br class="visible-lg" />
                                只为达致客户最理想的成果。</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-section">
                    <div class="row">
                        <div class="col-sm-push-4 col-md-push-5  col-sm-7">
                            ...
                            <p>形立方无时无刻都精力充沛，<br class="hidden-lg" />
                                为企业带来正能量！</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-section">
                    <div class="row">
                        <div class="col-sm-push-4 col-md-push-5  col-sm-7">
                            ...
                            <p>形立方在创业上不仅仅是大胆，还会打<br class="visible-md" />
                                破框框，<br class="visible-lg" />
                                为客户打造专属形象！</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="section" id="section4">
        <div class="col-md-6 maincol-right">
            <ul class="scene mascott purple">
                ...
                <li class="layer cube" data-depth="1"><img id="cube" src="/img/Mascott/Purple/CubeEvo_Mascot-Purple_Cube.png" style="position:relative;" width="150%" /></li>
            </ul>
        </div>
                ...
                <div class="content-section">
                    <div class="row">
                        <div class="col-sm-push-4 col-md-push-5  col-sm-7">
                            ...
                            <p>形立方的根本是创意设计，大前提必须是美感触觉，<br class="visible-lg" />
                                为客户建立完美形象！</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-section">
                    <div class="row">
                        <div class="col-sm-push-4 col-md-push-5  col-sm-7">
                            ...
                            <p>形立方的创意是一种天赋，精心打造独一无二的作品<br class="visible-lg" />
                                便是最大成就！</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="content-section">
                    <div class="row">
                        <div class="col-sm-push-4 col-md-push-5  col-sm-7">
                            ...
                            <p>形立方聆听客户声音，理解客户需求，务求<br class="visible-md" />
                                和谐的<br class="visible-lg" />
                                合作关系，共创最好的作品！</p>
                        </div>
                    </div>
                </div>
