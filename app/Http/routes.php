...
//Route::get('/annual-report', 'HomeController@getAnnualReport');
//Route::get('/packaging-design', 'HomeController@getPackagingDesign');
//Route::get('/visual-branding', 'HomeController@getVisualBranding');
//Route::get('/thematic-campaign', 'HomeController@getThematicCampaign');
//Route::get('/online-digital-platform', 'HomeController@getOnlineDigitalPlatform');
//Route::get('/explainer-video-production', 'HomeController@getExplainerVideoProduction');
...
Route::get('admin/manage/job-review/setActive/{job_id}', 'JobReviewController@setActive');
Route::get('admin/manage/job-review/setInactive/{job_id}', 'JobReviewController@setInactive');
